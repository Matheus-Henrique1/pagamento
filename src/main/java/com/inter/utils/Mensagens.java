...
public class Mensagens {
    ...
    public static final String SUCESSO_CADASTRAR_CLIENTE = "Cliente cadastrado com sucesso!";
    ...
    public static final String CPF_CARACTERES = "O campo CPF deve conter 11 caracteres.";
